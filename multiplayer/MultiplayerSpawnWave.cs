...
public class MultiplayerSpawnWave : Photon.MonoBehaviour
{
    ...
    private IEnumerator SpawnEnemy()
    {
        ...
        foreach (Transform location in spawnPoints)
        {
            ...
            {
                //spawn at child location
                PhotonNetwork.Instantiate("warzombie_f_pedrosoVariantTarget", location.position, location.rotation, 0);
